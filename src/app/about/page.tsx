...
export default function AboutPage() {
    return (
        <main>
            ...
            {/* Mission & Values */}
            <section className="max-w-[1200px] mx-auto px-4 md:px-6 lg:px-8 py-20" id="why">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <p className="uppercase tracking-widest text-xs text-black/40 mb-3">Our philosophy</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={v.title} className="rounded-2xl bg-white border border-black/5 shadow-sm p-5">
