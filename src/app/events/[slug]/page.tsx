...
export default function EventDetailPage({ params }: any) {
    ...
    return (
        <main className="page-wrap page-y">
            ...
            <Link
                href="/events"
                className="inline-flex items-center gap-2 text-sm text-black/50 hover:text-black transition mb-8"
            >
                ← All events
            </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
                ...
                <div className="lg:col-span-2">
                    {/* Hero image */}
                    <div className="relative w-full h-72 md:h-96 rounded-3xl overflow-hidden mb-10">
                        <Image
                            src={event.cover}
                            alt={event.title}
                            fill
                    ...
                    {/* Meta row */}
                    <div className="flex flex-wrap gap-4 text-sm text-black/60 mb-8">
                    ...
                    <div className="prose prose-neutral max-w-none">
                        ...
                        <h2 className="text-xl font-extrabold mt-10 mb-4">What to expect</h2>
                        ...
                        <h2 className="text-xl font-extrabold mt-10 mb-4">Venue & Directions</h2>
